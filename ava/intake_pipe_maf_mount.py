...
tube_length = 120
wall_thickness = 2
locating_tab_position = placeholder(26)  # I think this is wrong...
locating_tab_depth = placeholder(7)
locating_tab_width = placeholder(3)
locating_tab_height = placeholder(5)  # unimportant
locating_tab_fillet = 0.5
lip_thickness = placeholder(2)
lip_depth = placeholder(4)
maf_position = placeholder(58)
maf_mount_id = placeholder(26)
maf_mount_standoff_thickness = placeholder(4)
maf_mount_standoff_height = placeholder(2.5)
maf_holes = [
    (placeholder(23), placeholder(13)),
    (placeholder(-18), placeholder(-28)),
]
maf_screw_hole_id = placeholder(6)  # TODO: heatserts...
maf_screw_hole_depth = placeholder(7)  # TODO: heatserts...
maf_screw_mount_od = placeholder(10)  # TODO: heatserts...
maf_screw_mount_height = placeholder(5)  # MEASURED FROM `maf_mount_standoff_height` from top radius of pipe
...
result = (
    ...
    # .edges("(not %CIRCLE) and (not %LINE) and (<Y)")
    # .fillet(2)
    # maf mount screw #1 standoff, base
    ...
    .faces(">X")
    .fillet(maf_mount_standoff_thickness / 4)
    # locator tab
    .faces("|Z or |Y")
    .edges()
    .fillet(0.5)
